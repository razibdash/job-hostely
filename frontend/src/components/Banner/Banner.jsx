    ...
    <div className="bg-slate-50 max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14">
      ...
      <form>
        <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4 ">
          <div className="flex md:rounded-s-md  shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-300 md:w-1/2 w-full">
            <input
              type="text"
              name="title"
